  ...
  export default {
    ...
    methods: {
      ...
      editSave() {
        ...
        this.list[this.selectedId].user_sex = this.user_sex;
        ...
        this.list[this.selectedId].user_healthCondition = this.user_healthCondition;
        this.list[this.selectedId].user_politicsStatus = this.user_politicsStatus;
        this.list[this.selectedId].user_maritalStatus = this.user_maritalStatus;
        this.list[this.selectedId].user_educationBackground = this.user_educationBackground;
        ...
        this.list[this.selectedId].user_workState = this.user_workState;
        this.list[this.selectedId].user_dateOnBoard = this.user_dateOnBoard;
        this.list[this.selectedId].user_contractType = this.user_contractType;
        this.list[this.selectedId].user_whetherInOffice = this.user_whetherInOffice;
