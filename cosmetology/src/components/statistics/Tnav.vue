...
<script>
  ...
  export default {
    ...
    methods:{
      ...
      // postData(){
      //   let api = 'http://5cec9881b779120014b4974f.mockapi.io/demo/lxy';
      //   this.$axios.post(api).then(function (res) {
      //     console.log('hahah');
      //     console.log(res)
      //   }).catch(error=>{
      //     console.log('ERROR',error.message);
      ...
      // }
      // postData(){
      //   let url = 'http://5cec9881b779120014b4974f.mockapi.io/demo/lxy';
      //   this.$axios.post(url,{id:1}).then(function (res) {
      ...
      //     method:'get',
      //     baseURI:'/api',
      //     url:'http://5cec9881b779120014b4974f.mockapi.io/demo/lxy'
      //   })
      // },
      // getDataHM(){
      //   return this.$axios({
      ...
      // getDataMMM (){
      //   // let api = 'http://5cec9881b779120014b4974f.mockapi.io/demo/lxy';
      //   this.$axios.all(this.getDataH(),this.getDataHM()).then(function (res) {
      //     console.log('hahah');
      //     console.log(res.data)
      //   }).catch(error=>{
      //     console.log('ERROR',error.message);
